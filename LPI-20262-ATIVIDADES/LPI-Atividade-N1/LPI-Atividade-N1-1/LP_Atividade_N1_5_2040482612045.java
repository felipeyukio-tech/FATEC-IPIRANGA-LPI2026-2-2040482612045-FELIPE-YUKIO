...
public class LP_Atividade_N1_5_2040482612045 {
    public static void main(String[] args) {
        ...
        boolean fracionadoPerfeito = (sobraCaixa == 0);
        System.out.println("O estoque está perfeitamente fracionado em caixas completas? " + fracionadoPerfeito);
